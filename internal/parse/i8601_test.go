...
func TestParse8601(t *testing.T) {
	tests := []struct {
		...
		{
			name:       "2022-10-08T10:31:29+0900",
			data:       "2022-10-08T10:31:29+0900",
			wantUnix:   1665192689,
			wantNano:   0,
			wantOffset: 9 * 3600,
		},
		{
			name:       "2022-11-12T08:13:14+0900",
			data:       "2022-11-12T08:13:14+0900",
			wantUnix:   1668208394,
			wantNano:   0,
			wantOffset: 9 * 3600,
		},
